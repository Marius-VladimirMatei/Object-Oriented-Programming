...
class TestAccountManger(unittest.TestCase):
    def test_add_account(self):
        ...
        self.assertEqual(account_manager._accounts[credit_account._account_number]._balance, 1000)
        ...
        self.assertEqual(account_manager._accounts[debit_account._account_number]._account_holder, "Michale Jackson")

    def test_add_duplicate(self):
        account_manager = AccountManager()  # instance needed to be created for testing duplicate accounts

        debit_account = DebitAccount("999999999", "Michale Jackson", 9099, 1344)
        debit_account_2 = DebitAccount("999999999", "Michale Jacwefwefwekson", 94356099, 13434564)
